---
title: "Chart Prep Shouldn't Take Your Staff an Hour Per Patient"
description: "Before every visit, someone reconstructs the patient's story from scratch — what's active, what happened last time, what's overdue. It's invisible labor, it's redone from zero every single visit, and it's pure reconstruction toil. Here's why it takes so long and what it should be instead."
seoTitle: "Chart Prep Shouldn't Take Your Staff an Hour Per Patient"
seoDescription: "Chart prep is one of the largest uncounted labor costs in primary care. Why reconstructing the patient's picture before every visit takes so long, the three ways practices pay for it, and what prep looks like when the record holds the picture."
author: "Jacob Kantrowitz MD, PhD"
publishDate: "2026-07-12"
tags: ["practice-operations", "information-chaos"]
readTime: "5"
draft: false
linkedinCaption: "It's 7:45 in the morning and someone in your office is already doing archaeology. An MA working through the day's schedule, a provider prepping the night before, a nurse building huddle sheets by hand — reconstructing each patient's current picture from a stack of dated visits, from scratch, every single day. Chart prep is one of the largest labor costs in a primary care practice and almost nobody counts it, because it never shows up as a line item. And here's the thing: the reconstruction is only necessary because the record doesn't hold the picture. It holds encounters. Every practice pays for that in one of three ways — staff hours, provider time, or a worse visit. The bill is always due. It shouldn't be. The current picture of the patient should already exist when you open the chart:"
---
