---
title: "Where Referrals Go to Die"
description: "A referral is a handoff, and handoffs are where continuity of care quietly breaks. The letter, the fax, the follow-through, the note that comes back — or doesn't — and nobody tracking any of it. Here's why referrals vanish, and what it takes to make them something you can actually see."
seoTitle: "Where Referrals Go to Die — Why Referral Loops Never Close"
seoDescription: "Referral leakage is where continuity of care breaks most reliably. Why referrals vanish into the fog after they leave the practice, and how making the loop a visible, tracked object stops the silent death."
author: "Jacob Kantrowitz MD, PhD"
publishDate: "2026-07-12"
tags: ["care-coordination", "practice-operations"]
readTime: "5"
draft: false
linkedinCaption: "You decide a patient needs a specialist. That's the easy part. What happens next is a small relay race with a lot of places to drop the baton: the letter that gets faxed — or doesn't. The patient who calls to schedule — or doesn't. The specialist's note that comes back — or doesn't, and you find out months later when the patient returns and you ask how the visit went and they say *what visit?* Referrals die because they're not tracked objects — they're events, buried in a note from three weeks ago that nobody will reread. You can't follow up on a loop you can't see is open. The first fix isn't automation. It's visibility: make the referral a persistent, tracked thing with a status, and the silent death mostly stops. Here's why referrals vanish, and what it takes to make them something you can actually see:"
---
