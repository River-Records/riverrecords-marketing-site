...
description: "The enormous, unmeasured labor that stands between a physician and the practice of medicine. On articulation work, extraneous load, moral injury, and why removing friction is different from resilience training."
seoTitle: "The Work Before the Work — Articulation Work, Extraneous Load, and Moral Injury"
...
readTime: "9"
draft: false
linkedinCaption: "It's 7:40 on a Tuesday night and you're still in the chart. In the last twenty minutes, what did you actually decide? Probably not much. You reconciled a med list against a discharge summary written by someone who didn't know the patient. You scrolled a consult looking for the one line that mattered. You logged a follow-up you'd already written in your assessment. None of that is medicine — all of it is required before medicine can happen. This is the work before the work, and I've come to believe it's the single most underexamined problem in clinical practice. It's invisible because it doesn't bill, doesn't get measured, doesn't get taught, and expertise disguises it. Some of the moral injury physicians describe isn't in the big institutional battles — it's in the friction. And unlike prior auth, this class of problem is tractable. Removing articulation work isn't a mindfulness module for the wounded party. It's changing the work. Most physicians I know aren't asking to work less. They're asking for their work to be the work."
---
