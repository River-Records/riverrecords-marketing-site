...
order: 15
description: "EHR write-back limits and double validation keep the full vision out of reach today. The pragmatic bridge — and six questions to ask any documentation vendor now."
seoTitle: "Why the Problem-Oriented Chart Can't Fully Ship Yet — and the Bridge"
seoDescription: "EHR write-back limits and double validation keep the full vision out of reach today. The pragmatic bridge — and six questions to ask any documentation vendor now."
relatedPosts:
  - slug: "the-bridge-not-the-destination"
    title: "The Bridge, Not the Destination"
  - slug: "the-note-was-never-the-point"
