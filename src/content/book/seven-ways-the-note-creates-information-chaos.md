---
title: "Seven Ways the Note Creates Chaos"
chapterLabel: "Chapter 7"
part: "Part II — Information Chaos"
order: 8
description: "Atomic storage, uneditable documents, the timeslice/state conflict, chart-sized notes, slow updates, historical thread boundaries, and attestation-by-retyping — with the fix for each."
seoTitle: "7 Ways the Clinical Note Causes Information Chaos"
seoDescription: "Atomic storage, uneditable documents, the timeslice/state conflict, chart-sized notes, slow updates, historical thread boundaries, and attestation-by-retyping — with the fix for each."
relatedPosts:
