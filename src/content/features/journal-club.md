...
slug: "journal-club"
name: "Journal Club"
description: "Each week Stream reads the conditions you actually documented and delivers a short reading list about them — titles, abstracts and links, waiting on Monday. You never go looking."
headline: "The Reading Should Come to You"
subheadline: "Keeping up with the literature is mathematically impossible. Journal Club uses the problems you actually saw last week to bring a short, relevant reading list to you — no searching, no triage, no decision at the end of a long clinic."
seoTitle: "Journal Club in Stream — Weekly Reading From the Problems You Actually Saw"
seoDescription: "Journal Club reads the conditions you documented each week and delivers a short reading list from the published literature. Not decision support, no CME credit — lifelong learning that arrives where you already work."
hasPage: true
draft: false
order: 15
tags: ["beyond-the-scribe", "longitudinal-care", "ai-assistant"]
bullets:
...
faq:
  - question: "Where do the articles come from?"
    answer: "Published literature, indexed from PubMed, filtered to the conditions you documented in the previous week. You get titles, abstracts, and a link straight to the source so you can read the paper itself rather than a summary of it."
  - question: "How does Stream know what to send me?"
    answer: "It reads the diagnoses you documented over the previous week, and the ages of the patients you were managing them in. If you saw a lot of type 2 diabetes, that is what next Monday's list is about. The relevance is not a promise about an algorithm — it is a property of where the input comes from."
  - question: "Is this clinical decision support?"
  ...
  - question: "Does it earn CME credit?"
    answer: "No. Journal Club is not accredited and carries no CME credit. It is a way to keep reading when the week has not left room for it."
  - question: "Is it tied to a specific patient's chart?"
    answer: "No. Journal Club is deliberately disconnected from any individual chart. It looks at the shape of your week in aggregate — the conditions, not the people — and nothing it surfaces is attached to a patient record."
  - question: "Can I comment on the articles or discuss them with colleagues?"
    answer: "Not in this version. The current release is deliberately simple: it reads your week and hands you a list. Commenting, annotation and discussion are the natural next step, and would turn a reading list into something closer to real dissemination of evidence — but they are not built yet."
---
...
We wrote about the reasoning at greater length in [The Reading Should Come to You](/blog/the-reading-should-come-to-you/).
